...
async function main() {
    try {
        ...
        //     const sqlLiteQuery = JSON.parse(await assistant.generateSQLLiteQuery(userQuestion));

        //     // Executing the generated SQLLite query and getting response
        //     const sqlLiteResponse = await query(sqlLiteQuery.sqlLite_query);
        //     const assistantResponse = await assistant.answerSqlLiteQuery(sqlLiteResponse);
        ...
        // console.log("Alrighty then, I hope you found the answers you were looking for!\n");
        readline.close();
    } catch (error) {
